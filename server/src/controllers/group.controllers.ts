...
export const getGroupUsersController = asyncHandler(
  async (req: Request, res: Response) => {
    try {
      const currentUserId = req.user?.id as string;
...
export const getGroupDetailController = asyncHandler(
  async (req: Request, res: Response) => {
    try {
...
export const addMemberController = asyncHandler(
  async (req: Request, res: Response) => {
    try {
      ...
      const currentFriend = await userService.getUserDetails(
...
export const addGroupExpenseController = asyncHandler(
  async (req: Request, res: Response) => {
    try {
...
export const updateGroupExpenseController = asyncHandler(
  async (req: Request, res: Response) => {
    try {
      const { groupId } = req.params;
...
export const deleteGroupExpenseController = asyncHandler(
  async (req: Request, res: Response) => {
    try {
      const currentUserId = req.user?.id as string;
      const { groupId } = req.params;
