...
export const getFriendSettlementController = asyncHandler(async(req:Request,res:Response) => {
    try {
...
export const settleFriendSettlementController = asyncHandler(async(req:Request,res:Response) => {
    try {
        const currentUserId = req.user?.id as string;
...
export const groupSettlementInfoController = asyncHandler(async(req:Request,res:Response) => {
    try {
        const {groupId} = req.params

        const currentUserId = req.user?.id as string;

        const info = await settlementService.groupSettlementInfo(currentUserId,groupId);
...
export const settleGroupDebtController = asyncHandler(async(req:Request,res:Response) => {
    try {
        const currentUserId = req.user?.id as string;
