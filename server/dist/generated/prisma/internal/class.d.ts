...
> {
   ...
   * ```
   */
  get friendship(): Prisma.FriendshipDelegate<
    ExtArgs,
    {
      omit: OmitOpts;
    }
   ...
   * ```
   */
  get balance(): Prisma.BalanceDelegate<
    ExtArgs,
    {
      omit: OmitOpts;
    }
   ...
   * ```
   */
  get groupMember(): Prisma.GroupMemberDelegate<
    ExtArgs,
    {
      omit: OmitOpts;
    }
   ...
   * ```
   */
  get expense(): Prisma.ExpenseDelegate<
    ExtArgs,
    {
      omit: OmitOpts;
    }
   ...
   * ```
   */
  get expenseSplit(): Prisma.ExpenseSplitDelegate<
    ExtArgs,
    {
      omit: OmitOpts;
    }
   ...
   * ```
   */
  get activity(): Prisma.ActivityDelegate<
    ExtArgs,
    {
      omit: OmitOpts;
    }
   ...
   * ```
   */
  get settlement(): Prisma.SettlementDelegate<
    ExtArgs,
    {
      omit: OmitOpts;
    }
