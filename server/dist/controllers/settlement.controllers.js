...
export const getFriendSettlementController = asyncHandler(async (req, res) => {
    try {
...
export const settleFriendSettlementController = asyncHandler(async (req, res) => {
    try {
        const currentUserId = req.user?.id;
        const { friendId } = req.params;
...
export const groupSettlementInfoController = asyncHandler(async (req, res) => {
    try {
...
export const settleGroupDebtController = asyncHandler(async (req, res) => {
    try {
        const currentUserId = req.user?.id;
        const { amount, note } = req.body;
...
//# sourceMappingURL=settlement.controllers.js.map