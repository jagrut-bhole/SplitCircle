...
export const addFriendExpenseController = asyncHandler(async (req, res) => {
    try {
        const { username, title, amount, description, scenario } = req.body;
...
export const friendExpenseListController = asyncHandler(async (req, res) => {
    try {
...
export const singleExpenseDetailController = asyncHandler(async (req, res) => {
    try {
...
export const updateFriendExpenseController = asyncHandler(async (req, res) => {
    try {
        const { expenseId } = req.params;
        const currentUserId = req.user?.id;
        const { title, description, amount, scenario } = req.body;
...
export const deleteFriendExpenseController = asyncHandler(async (req, res) => {
    try {
        const { expenseId } = req.params;
        const currentUserId = req.user?.id;
        if (!currentUserId) {
