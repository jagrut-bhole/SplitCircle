...
export declare const getUserTotalOwedController: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getUserTotalGroupsController: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getFriendController: (req: Request, res: Response, next: import("express").NextFunction) => void;
